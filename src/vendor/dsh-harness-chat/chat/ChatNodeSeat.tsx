...
import type { ChatNodeOwnerProps, ChatViewSlotProps } from '../contract/slots.js'
import type { ChatNode } from '../contract/chat-nodes.js'
...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  return (
    ...
    >
      {renderSlot('conversation.chat.node', routedOwner as never, {
