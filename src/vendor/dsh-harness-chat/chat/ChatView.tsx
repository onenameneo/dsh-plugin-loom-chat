...
import type { ChatViewSlotProps } from '../contract/slots.js'
import type { ChatSnapshot } from '../contract/snapshot.js'
...
import { mergeTurnRailItems, type TurnRailItem } from './turn-rail-items.js'
...
export function ChatView({
  ...
  const turnOutline = (useProjection as unknown as (key: string) => unknown)('turnOutline')
