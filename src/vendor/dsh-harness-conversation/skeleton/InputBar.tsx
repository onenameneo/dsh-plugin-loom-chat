...
import type { ComposerBarProps } from '../contract/slots.js'
...
export const InputBar = memo(function InputBar({
  ...
  useEffect(() => {
    ...
    showToast(error.code === 'session/attachment-invalid' || String(error.code) === 'subagent/attachment-invalid'
      ? attachmentErrorText(t, String((error.details as { reason?: unknown }).reason ?? error.code), imageLimits)
